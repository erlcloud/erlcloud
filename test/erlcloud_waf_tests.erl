...
create_byte_match_set_tests(_) ->
    ...
    PostData = erlcloud_json:encode([{<<"ChangeToken">>, ?CHANGE_TOKEN},
                           {<<"Name">>, ?NAME_PARAM}]),
...
get_byte_match_set_tests(_) ->
    ...
    PostData = erlcloud_json:encode([{<<"ByteMatchSetId">>, ?CREATE_ID}]),
    Response = [{<<"ByteMatchSet">>,
                [{<<"ByteMatchSetId">>, ?CREATE_ID},
                 {<<"ByteMatchTuples">>,[]},
                 {<<"Name">>, ?NAME_PARAM}]}],
...
get_ip_set_tests(_) ->
    ...
    PostData = erlcloud_json:encode([{<<"IPSetId">>, ?CREATE_ID}]),
...
get_rule_tests(_) ->
    ...
    PostData = erlcloud_json:encode([{<<"RuleId">>, ?CREATE_ID}]),
    Response = [{<<"Rule">>,
                [{<<"MetricName">>, ?METRIC_NAME_PARAM},
                 {<<"Name">>, ?NAME_PARAM},
                 {<<"Predicates">>,[]},
...
get_size_constraint_set_tests(_) ->
    ...
    PostData = erlcloud_json:encode([{<<"SizeConstraintSetId">>, ?CREATE_ID}]),
...
get_sql_injection_match_set_tests(_) ->
    ...
    PostData = erlcloud_json:encode([{<<"SqlInjectionMatchSetId">>, ?CREATE_ID}]),
...
get_web_acl_tests(_) ->
    ...
    PostData = erlcloud_json:encode([{<<"WebACLId">>, ?CREATE_ID}]),
    Response = [{<<"WebACL">>,
                [{<<"DefaultAction">>, [{<<"Type">>,<<"BLOCK">>}]},
                 {<<"MetricName">>, ?METRIC_NAME_PARAM},
                 {<<"Name">>, ?NAME_PARAM},
...
get_xss_match_set_tests(_) ->
    ...
    PostData = erlcloud_json:encode([{<<"XssMatchSetId">>, ?CREATE_ID}]),
    Response = [{<<"XssMatchSet">>,
                [{<<"XssMatchSetId">>, ?CREATE_ID},
                 {<<"XssMatchTuples">>,[]},
                 {<<"Name">>, ?NAME_PARAM}]}],
...
get_sampled_requests_tests(_) ->
    ...
    PostData = erlcloud_json:encode([{<<"MaxItems">>, ?LIMIT_SIZE},
                           {<<"RuleId">>, ?RULE_ID},
...
list_byte_match_sets_tests(_) ->
    ...
    PostData = erlcloud_json:encode([{<<"Limit">>, ?LIMIT_SIZE}]),
...
list_ip_sets_tests(_) ->
    ...
    PostData = erlcloud_json:encode([{<<"Limit">>, ?LIMIT_MAX}]),
    Response = [{<<"IPSets">>,
                [[{<<"IPSetId">>, ?CREATE_ID},
                  {<<"Name">>, ?NAME_PARAM}]]},
                {<<"NextMarker">>, ?NEXT_MARKER}],
