...
route53_test_() ->
    {foreach, fun setup/0, fun meck:unload/1, [
        fun api_tests/1
    ]}.
...
mocked_create_alias() ->
    {
        [
            ?BASE_URL ++ "functions/name/aliases",
            post,
            '_',
            <<"{\"FunctionVersion\":\"$LATEST\",\"Name\":\"aliasName1\"}">>,
            '_',
            '_'
        ],
        make_response([
...
mocked_create_event_source_mapping() ->
    {
        [
            ?BASE_URL ++ "event-source-mappings",
            post,
            '_',
        ...
        [
            ...
            jsx:encode([
                {<<"Code">>, [
                    {<<"S3Bucket">>, <<"bi-lambda">>},
                    {<<"S3Key">>,
                        <<"local_transform/bi-assets-environment-create-environment_1-0-0_latest.zip">>}
                ]},
                {<<"FunctionName">>, <<"name">>},
...
mocked_invoke_qualifier() ->
    {
        [
            ?BASE_URL ++ "functions/name_qualifier/invocations?Qualifier=123",
            post,
            '_',
            <<"{}">>,
            '_',
...
mocked_list_event_source_mappings() ->
    {
        [
            ?BASE_URL ++
                "event-source-mappings/?EventSourceArn=arn%3Aaws%3Akinesis%"
        ...
        make_response([
            {<<"Functions">>, [
                [
                    ...
                    {<<"Description">>, <<>>},
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:bi-assets-asset-create-host">>},
                ...
                [
                    ...
                    {<<"Description">>, <<>>},
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:bi-assets-asset-create-host1">>},
                ...
                [
                    ...
                    {<<"Description">>, <<>>},
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:bi-driver">>},
                ...
                [
                    ...
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:eholland-js-router">>},
                ...
                [
                    ...
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:eholland-test-aims-users">>},
                ...
                [
                    ...
                    {<<"Description">>,
                        <<"An Amazon Kinesis stream processor that logs the data being published.">>},
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:eholland-test-router">>},
                ...
                [
                    ...
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:us-east-1_base_eholland_master_lambda_route">>},
                ...
                [
                    ...
                    {<<"Description">>, <<>>},
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:us-east-1_base_eholland_master_lambda_route-aims-user-create">>},
                    {<<"FunctionName">>,
                        <<"us-east-1_base_eholland_master_lambda_route-aims-user-create">>},
                    {<<"Handler">>, <<"lambda_function.lambda_handler">>},
        ...
        make_response([
            ...
            {<<"Versions">>, [
                [
                    ...
                    {<<"Description">>, <<>>},
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:name:$LATEST">>},
                    {<<"FunctionName">>, <<"name">>},
                    {<<"Handler">>, <<"index.process">>},
                    {<<"LastModified">>, <<"2015-12-10T13:57:48.214+0000">>},
                    {<<"MemorySize">>, 512},
                ...
                [
                    ...
                    {<<"Description">>, <<>>},
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:name:1">>},
                    {<<"FunctionName">>, <<"name">>},
                    {<<"Handler">>, <<"index.process">>},
                ...
                [
                    ...
                    {<<"Description">>, <<>>},
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:name:2">>},
                    {<<"FunctionName">>, <<"name">>},
                    {<<"Handler">>, <<"index.process">>},
...
mocked_update_function_configuration() ->
    {
        [
            ?BASE_URL ++ "functions/name/configuration",
            put,
            '_',
...
api_tests(_) ->
    [
                ...
                {ok, [
                    {<<"Functions">>, [
                        ...
                        [
                            ...
                            {<<"Description">>, <<>>},
                            {<<"FunctionArn">>,
                                <<"arn:aws:lambda:us-east-1:352283894008:function:name2">>},
                            {<<"FunctionName">>, <<"name2">>},
                            {<<"Handler">>, <<"index.process">>},
                            {<<"LastModified">>, <<"2015-12-10T11:31:21.106+0000">>},
                            {<<"MemorySize">>, 128},
        ...
        fun() ->
            Result = erlcloud_lambda:create_alias(
                <<"name">>,
                <<"$LATEST">>,
                <<"aliasName1">>,
                []
        ...
        fun() ->
            Result = erlcloud_lambda:create_function(
                #erlcloud_lambda_code{
                    s3Bucket = <<"bi-lambda">>,
                    s3Key = <<
                        "local_transform/bi-ass"
        ...
        fun() ->
            Result = erlcloud_lambda:invoke(
                <<"name:alias">>, [], [raw_response_body], #aws_config{}
            ),
            Expected = {ok, <<"{\"message\":\"Hello World!\"}">>},
            ?assertEqual(Expected, Result)
        end,
        ...
        fun() ->
            ...
            Expected =
                {ok, [
                    ...
                    {<<"Description">>, <<>>},
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:name:3">>},
                    {<<"FunctionName">>, <<"name">>},
                    {<<"Handler">>, <<"index.process">>},
                    {<<"LastModified">>, <<"2015-12-10T13:57:48.214+0000">>},
                    {<<"MemorySize">>, 512},
        ...
        fun() ->
            ...
            Expected =
                {ok, [
                    ...
                    {<<"Description">>, <<>>},
                    {<<"FunctionArn">>,
                        <<"arn:aws:lambda:us-east-1:352283894008:function:name:4">>},
                    {<<"FunctionName">>, <<"name">>},
                    {<<"Handler">>, <<"index.process">>},
                    {<<"LastModified">>, <<"2015-12-11T14:29:17.023+0000">>},
                    {<<"MemorySize">>, 512},
...
make_response(Value) when is_binary(Value) ->
    make_response({200, <<"OK">>}, Value);
make_response(Value) ->
    make_response({200, <<"OK">>}, jsx:encode(Value)).
