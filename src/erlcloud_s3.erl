...
-spec make_post_url(integer(), string(), string(), string()) -> {iolist(), iolist()}.

make_post_url(Expire_time, BucketName, Key, Policy) ->
    make_post_url(Expire_time, BucketName, Key, Policy, default_config()).
