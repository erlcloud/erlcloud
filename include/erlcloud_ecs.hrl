...
-record(ecs_task, {
    ...
    connectivity_at :: undefined | binary(),
    container_instance_arn :: undefined | binary(),
    containers :: undefined | [#ecs_container{}],
    cpu :: undefined | binary(),
    created_at :: undefined | binary(),
    ...
    pull_started_at :: undefined | binary(),
    pull_stopped_at :: undefined | binary(),
    started_at :: undefined | binary(),
    started_by :: undefined | binary(),
    stopped_at :: undefined | binary(),
